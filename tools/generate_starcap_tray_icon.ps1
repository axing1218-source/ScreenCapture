...
# Tray-specific optical sizing. At 100% Windows normally asks for a 16px
# small icon. The approved StarCap geometry is intentionally expanded so the
# coloured mark occupies almost the full notification-area canvas, similar to
# mature tray applications, while the normal application icon remains unchanged.
$trayZoom = @{
    16 = 1.16
    20 = 1.16
    24 = 1.16
...
Write-Host "16/20/24px optical zoom: 116%"
