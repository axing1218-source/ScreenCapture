...
namespace Ling
{
    ...
    public:
        ...
        {
            downTok = win->onMouseDown.add([this, win](POINT pos, bool isRight) {
            ...
            keyTok = win->onKeyDown.add([this, win](UINT key) {
                if (auto* bridge = StarCapOcrLinkedSelection::bridgeFor(win))
    ...
    public:
        explicit StarCapOcrLinkedTextBox(WinBase* win) : TextBox(win)
        {
            ...
            focusTok = onFocusChanged.add([this, win](TextBox*, bool focused) {
                if (focused) return;
